                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="basicInput">Nama Ekstrakurikuler</label> <span class="text-danger">*</span>
                                        <input type="text" class="form-control @error('nama') is-invalid @enderror" value=" {{$kegiatan->nama}} " name="nama" placeholder="Nama Ekstrakurikuler" />
                                        @error('nama')
